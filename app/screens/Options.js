    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Image
              ...
              resizeMode="contain" />
              <Text style={{textAlign:'center', position: 'absolute', fontSize: 20, fontWeight:'bold'}}>Start {'\n'} Singing</Text>
              </TouchableOpacity>
          </View>
          <View>
              <TouchableOpacity style={[styles.box, {
             ...
             <Image
              ...
              source={require("../assets/karaoke.png")}
              resizeMode="contain" />
              <Text style={{textAlign:'center',position: 'absolute', fontSize: 20, fontWeight:'bold'}}>Recognize Song</Text>
          </TouchableOpacity>
          </View>
